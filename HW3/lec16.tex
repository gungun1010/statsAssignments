...
\caption{test error for upto 40 iterations.I can see a dip at 11th iteration. The testing error and then fluctuates alone the similiar domain.To understand why, I plotted training error to see the convergence.}
\end{figure}
