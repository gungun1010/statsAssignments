...
\caption{test error for upto 200 iterations.I can see a dip at about 30th iteration. The testing error and then fluctuates alone the similiar domain.To understand why, I plotted training error to see the convergence.}
\end{figure}
...
\caption{Training error for upto $60$ splits. The iteration is fixed to 3. I see it reachs the best testing error (17\% ish) while number of splits equals to 10. If i increase the depth even further, it is the case of overfitting as I do not see any performance gain; instead, the testing error was increased to 18\%  }
\end{figure}
